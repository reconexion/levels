  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col gap-1">
        <span className="text-xs tracking-wide text-quaternary uppercase">{t('Your character')}</span>
        <span className="text-sm font-semibold text-primary">{t(skin.name)}</span>
