...
// `name` is English canonical (never stored — only `id` is persisted/sent to the API),
// pass it through t() wherever it's displayed. Same tier names as game/bossTier.js.
export const BOSS_STYLES = [
  { id: 'noob', name: '1. Noob', colorA: '#9a9a9a', colorB: '#7a7f86', aura: 0, badge: null, crooked: true },
  { id: 'principiante', name: '2. Beginner', colorA: '#b9cfe3', colorB: '#5ec8ff', aura: 0.12, badge: null },
  { id: 'amateur', name: '3. Amateur', colorA: '#c7d8ea', colorB: '#5ec8ff', aura: 0.28, badge: null },
  { id: 'competente', name: '4. Competent', colorA: '#c9954f', colorB: '#ffe6ad', aura: 0.22, badge: null, wood: true },
  { id: 'avanzado', name: '5. Advanced', colorA: '#12151a', colorB: '#39ff9e', aura: 0.55, badge: null, neon: true },
  { id: 'experto', name: '6. Expert', colorA: '#c7cfd6', colorB: '#eef2f6', aura: 0.3, badge: null, chrome: true },
  { id: 'elite', name: '7. Elite', colorA: '#3a1330', colorB: '#ff5d7a', aura: 0.42, badge: null },
  { id: 'maestro', name: '8. Master', colorA: '#caa023', colorB: '#fff0c2', aura: 0.45, badge: 'crown', gold: true },
  { id: 'leyenda', name: '9. Legend', colorA: '#ff5ec8', colorB: '#5ec8ff', aura: 0.6, badge: 'star', holo: true, particles: 8 },
